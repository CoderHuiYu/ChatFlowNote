...
- (void)addBottomSeparatorForView {
    UIView *bottomSeparatorView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 1, UIScreen.mainScreen.bounds.size.width, 1)];
    bottomSeparatorView.tag = 2000;
    bottomSeparatorView.backgroundColor = UIColor.zillyShadow;
    [self addSubview:bottomSeparatorView];
}

- (void)addTopSeparatorForView {
    UIView *topSeparatorView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, UIScreen.mainScreen.bounds.size.width, 1)];
    topSeparatorView.tag = 1000;
    topSeparatorView.backgroundColor = UIColor.zillyShadow;
    [self addSubview:topSeparatorView];
}

- (void)addSeparatorsForView {
    [self addTopSeparatorForView];
    [self addBottomSeparatorForView];
}
